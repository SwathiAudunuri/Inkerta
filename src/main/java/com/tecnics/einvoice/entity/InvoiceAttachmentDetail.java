...
public class InvoiceAttachmentDetail implements Serializable {
	...
	public InvoiceAttachmentDetail(Timestamp created_on, String docType, String docId, Integer doc_size,
	...
	public InvoiceAttachmentDetail() {
		super();
	}

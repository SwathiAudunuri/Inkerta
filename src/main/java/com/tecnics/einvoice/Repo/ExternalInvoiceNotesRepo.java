...
public interface ExternalInvoiceNotesRepo extends CrudRepository<ExternalInvoiceNotes, Integer> {

	List<ExternalInvoiceNotes> findByPartnerId(String partnerId);
	
	@Query(nativeQuery = true, value=SQLQueries.FETCH_EXTERNAL_INV_NOTES)
